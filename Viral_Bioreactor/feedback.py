...
# ax1[2].set_ylabel(r"$D$ (1/h)")
# ax1[0].set_xlabel(r"Time (h)")
# ax1[1].set_xlabel(r"Time (h)")
# ax1[2].set_xlabel(r"Time (h)")
...
ax3[2].set_ylabel(r"$D$ (1/h)")
ax3[0].set_xlabel(r"Time (h)")
ax3[1].set_xlabel(r"Time (h)")
ax3[2].set_xlabel(r"Time (h)")
